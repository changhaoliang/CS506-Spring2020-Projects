...
def result_visualization(num_affirmed, num_part, num_reversed, num_remanded, num_nonremanded,
                         num_affirmed_noKeywords, num_part_noKeywords, num_reversed_noKeywords,
                         num_remanded_noKeywords, num_nonremanded_noKeywords):
    """
...
def search_keywords(state, keywords):
    ...
    result_visualization(num_affirmed, num_part, num_reversed, num_remanded, num_nonremanded,
                         num_affirmed_N - num_affirmed, num_part_N - num_part, num_reversed_N - num_reversed,
                         num_remanded_N - num_remanded, num_nonremanded_N - num_nonremanded)
